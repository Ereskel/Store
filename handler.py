...
Хотя, вообще, это многое упрощает. По сути задача будет состоять в переносе данных из одной таблицы в другую. И это можно сделать 
при нажатии на одну клавишу. Попробуем.

Хорошая идея естати! Я почему то об этом не подумал. 
